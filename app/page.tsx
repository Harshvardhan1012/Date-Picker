...
const WeeklyRecurrence = () => {
  const [recurring, setReccuring] = useState<number>(Frequency.WEEKLY);
  const [interval, setInterval] = useState(1); // Default interval of 1
  ...
  return (
    <div className="p-9 mx-48 bg-gray-100 rounded-lg shadow-md">
      <form>
        ...
        <select
          value={recurring}
          onChange={(e) => setReccuring(Number(e.target.value))}
        ...
        <h2 className="text-lg font-semibold mb-4">
          {FrequencySelect[recurring as keyof typeof FrequencySelect]}{" "}
          Recurrence
        </h2>
